package com.monkeyframework.context.message;
...
import com.monkeyframework.context.utils.MessageSourceUtility;
...
public class MessageManager {
    ...
    public static String getExceptionMessage(monkeyException monkeyException) {
    	Locale locale = Locale.CHINA;
    	String key = monkeyException.getKey();
        try {
            Assert.notNull(messageSourceAccessor, "请先设置错误消息的国际化资源");
            return messageSourceAccessor.getMessage(key, monkeyException.getParams(), locale);
